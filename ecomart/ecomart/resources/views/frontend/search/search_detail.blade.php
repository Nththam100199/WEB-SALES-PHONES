                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 col-xl-6 col-sm-9">
                                    ...
                                    <div class="toolbar-form">
                                        <form action="#">
                                            @if(isset($slug_product_menu))
                                            <input type="hidden" class="slug_product_menu" value="{{$slug_product_menu}}">
                                            @endif
                                            @if(isset($id_price))
                                            <input type="hidden" class="id_price" value="{{$id_price}}">
                                            @endif
                                            @if(isset($others_id))
                                            <input type="hidden" class="others_id" value="{{$others_id}}">
                                            @endif
                                            <div class="toolbar-select">
                                                <span>Sắp xếp:</span>
                                                <select data-placeholder="Mặc định" id="sort_search" class="order-by" tabindex="1">
