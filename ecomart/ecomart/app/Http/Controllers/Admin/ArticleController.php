...
class ArticleController extends Controller
{
    ...
    {      
        // phân quyền       
        $check = $this->functions->loadPageAdmin('article_manager','category');
    ...
    public function postAddArticle(Request $request , $id_cat){
        $data = $request->all(); 
        $data['slug'] = $this->functions->convert($request->name);
        $data['parent'] = 0;
    ...
    public function getAddArticle2($id_cat , $id_menu_art){
        ...
        // phân quyền
        $check = $this->functions->loadPageAdminTwo('article_menu_add','article',$id_cat);
    ...
    public function getEditCategory($id_edit){
        ...
        // phân quyền
        $check = $this->functions->loadPageAdminTwo('category_edit','article',$id_edit);
    ...
    public function getEditArticle($id_cat,$id_edit){
        ...
        // phân quyền
        $check = $this->functions->loadPageAdminTwo('article_menu_edit','article',$id_cat);
    ...
    public function postDelArticle ($id_cat,$id_del){
        ...
        // phân quyền
        $check = $this->functions->loadPageAdminTwo('article_menu_del','article',$id_cat);
    ...
    public function getArticleList($id_menu_art){
        ...
        $check = $this->functions->loadPageAdminTwo('article_list','article',$id_cat);
        if($check){
            $str = 'Bạn không được cấp quyền vào trang này !';
            $url = 'home';
            return view('loadPage.loadPageAdmin',compact('str','url'));
    ...
    public function getAddArticleList($id_menu_art){
        ...
        // phân quyền
        $id_cat = Article_menu::where('article_menu_id',$id_menu_art)->get()->pluck('category_id')->toArray()[0];
        $check = $this->functions->loadPageAdminTwo('article_add','article',$id_cat);
        if($check){
            $str = 'Bạn không được cấp quyền vào trang này !';
            $url = 'home';
            return view('loadPage.loadPageAdmin',compact('str','url'));
    ...
    public function getEditArticleList($id_art){
        ...
        $check = $this->functions->loadPageAdminTwo('article_edit','article',$id_cat);
        if($check){
            $str = 'Bạn không được cấp quyền vào trang này !';
            $url = 'home';
            return view('loadPage.loadPageAdmin',compact('str','url'));
