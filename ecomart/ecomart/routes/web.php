...
Route::group([
    ...
    // ajax
    Route::post('/sort/search','SearchController@postSortSearch')->name('post.ajax.sort.search');
    // endajx
    ...
    // ajax 
    Route::post('sort/cuahang','ComboController@postSortCuaHang')->name('sort.cuahang');
    // endajax
